...
from .routers import novels, outline, quality, storygraph, requirements, styles, trends, xhs
...
for _router in (novels, outline, quality, storygraph, requirements, styles, trends, xhs):
