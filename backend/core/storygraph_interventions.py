...
# 感官细节词库（按类型分类）
SENSORY_DETAILS = {
    "visual": ["光影在墙上晃动", "尘埃在光束中浮沉", "指甲缝里的泥", 
               "袖口磨出的线头", "铜镜上的绿锈", "茶水映出的人影"],
    "auditory": ["风穿过门缝的呜咽", "棋子落盘的脆响", "远处传来的犬吠",
                 "布帛撕裂的声音", "火堆里竹节爆开的噼啪声"],
    "tactile": ["粗糙的麻布擦过手背", "冰凉的石头透过鞋底", "茶水烫了舌尖",
               "刀刃上的寒气刺得皮肤发紧", "汗水顺着脊背往下淌"],
    "olfactory": ["雨后泥土的腥味", "陈年旧书的霉味", "药炉里飘出的苦香",
                  "铁锈和血腥混在一起的气味", "桂花糕的甜腻"],
    "inner": ["胃里像坠了块石头", "指尖微微发颤，他自己都没察觉", "嗓子眼发干",
              "胸口堵着一团棉花", "四肢像灌了铅"],
}
...
IMPERFECTION_BEATS = [
    "他话说一半突然卡住——忘了词。",
    "手一滑，杯子掉在地上。没碎，但茶洒了一地。",
    "明明想冷笑，嘴角却抽了一下——不够酷。",
    "推门太用力，门板撞在墙上弹了回来。",
    "她以为自己在笑，但镜子里那张脸看起来更像哭。",
    "脚下一绊。没人看见。但还是觉得丢人。",
    "说了一句不该说的话。说完就后悔了。",
    "握剑的姿势歪了——师父纠正过三次了，还是改不过来。",
]
