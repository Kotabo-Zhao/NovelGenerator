...
"""
        ...
        if fast_food:
            pacing_instruction = """## ⚡ 快餐模式 — 爆款网文节奏（严格遵循，违反 = 不合格）

你是在写能够在番茄小说/起点冲榜的爆款。读者耐心只有7秒。以下是硬规则：

### 黄金三章结构
- **前300字必须有冲突**：被退婚/被背叛/身份暴露/金手指觉醒/生死危机。直接炸。没有铺垫。
- **第一章完成第一次逆袭**：被欺负 → 反击 → 打脸。3000字内走完一个完整情绪闭环。
- **章末必须卡在关键节点**：身份即将暴露时、真相即将揭晓时、刀即将落下时——强制断章。

### 爽点密度 — 对标短剧节奏
- **每章(3000字)至少4个爽点**：打脸/碾压/揭秘/反转/实力展示。每600-800字必须有一个能让人"卧槽"的点。
- **每3章一个大高潮**：身份揭露/实力碾压/Boss战/关系逆转。大高潮后紧接新悬念。
- **虐不过两章**：主角被压制不超过2章就必须反击。读者不是来受气的。

### 对话铁律
- **对话不超过3轮**：三句话内必须有动作/冲突/反转打断。禁止闲聊、确认信息、情绪宣泄式对话。
- **每句话都要杀人**：对话只有三种功能：推进冲突、揭露信息、改变关系。其余全删。

### 写作风格
- **零心理描写**：不用"他感到""他意识到""他明白"。用动作和身体反应。
- **零环境描写**（除非是冲突场景）：不写天气、不写风景、不写房间布置。
- **零铺垫**：没有"几天后""与此同时""在这个过程中"。直接跳。读者会脑补。
- **全动作+对话**：80%以上的文字是角色在做什么或说什么。

### 反转要求
- **每章至少1个反转**：你以为他是弱鸡 → 他秒杀全场。你以为她要嫁了 → 她当众退婚。
- **反转不能预告**：不给提示，突然炸。读者要的就是措手不及。

### 人设要求
- **主角必须杀伐果断**：有仇当场报，有恩当场还。不犹豫、不纠结、不圣母。
- **反派必须极致**：坏得让人牙痒，死得让人解恨。不搞灰色人物。
- **配角功能化**：要么帮主角、要么害主角、要么被主角碾压。没有路人。

### 情绪闭环
每章执行：憋屈(0-500字) → 反击(500-2000字) → 打脸(2000-2500字) → 新悬念(2500-3000字)
不允许全程平淡。不允许全程高压。必须有起伏。
"""
