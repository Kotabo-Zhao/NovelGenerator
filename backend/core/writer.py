...
### 场景导演（选一种在本章主导，可混合）
20. **动作场景**: 快节奏。短句为主（≤12字占比>40%）。动作链: 感知→反应→动作→结果。视觉描写 > 心理描写。电影化: 把镜头语言转成文字——「剑尖离喉三寸」「地上只剩一只鞋」「血顺着石阶往下爬」。
21. **情感场景**: 中速。内心独白 + 身体微反应（🚫 禁止AI套路段落: 太阳穴突突跳/胸口发紧/手心出汗/心跳加速/呼吸急促/脊背发凉/胃里翻江倒海/瞳孔骤缩——这些都是AI批量生成的万能生理反应，真人写作不这么写）。正确做法: 「他张了张嘴，没出声」「指甲掐进掌心，不觉得疼」「把那句话咽了回去」「转了三圈才发现自己在原地」。对话中留沉默，留未说出口的话。
