...
from .routers import novels, outline, quality, storygraph, requirements, styles, trends, xhs, characters, feedback, tts
...
for _router in (novels, outline, quality, storygraph, requirements, styles, trends, xhs, characters, feedback, tts):
